...
@interface STKSImageRatingView ()

- (void)commonSetup;

@end

@implementation STKSImageRatingView
...
- (STKSImageRatingView *)initWithFrame:(CGRect)frame fullImage:(UIImage *)fullImage emptyImage:(UIImage *)emptyImage {
