//
//  STKSCameraImagePreviewsViewController.m
//  Stacks
//
...
@interface STKSCameraImagePreviewsViewController () <UIGestureRecognizerDelegate>

@property (strong, nonatomic) UIImageView *imageView1, *imageView2, *imageView3;

@end

@implementation STKSCameraImagePreviewsViewController
...
- (void)loadInImageForIndex:(NSInteger)index forImageView:(UIImageView *)imageView {
    ...
    [STKSUtilities recentImageNumberFromRecent:index completionBlock:^(UIImage *image) {
...
- (void)loadInImages {
    ...
    [STKSUtilities recentImageNumberFromRecent:0 completionBlock:^(UIImage *image) {
        _imageView1.image = image;
    }];
    
    [STKSUtilities recentImageNumberFromRecent:1 completionBlock:^(UIImage *image) {
        _imageView2.image = image;
    }];
    
    [STKSUtilities recentImageNumberFromRecent:2 completionBlock:^(UIImage *image) {
