...
@implementation STKSUtilities

+ (NSURL *)URLFromImageNames:(NSArray<NSString *>*)imageNames {
    
    NSArray *sortedArray = [imageNames sortedArrayUsingSelector:@selector(localizedCaseInsensitiveCompare:)];
    ...
    for (int i = 0; i < [sortedArray count]; i++) {
        ...
        [imageNamesString appendFormat:@"pictures[]=%@", sortedArray[i]];
    }
